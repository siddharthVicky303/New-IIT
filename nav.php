...
<style>
  ...
  <body>
    <h1 class="h_3" ><a href="index2.html" style="text-decoration: none; color: inherit;">Indian Institute of Technology Indore</a></h1>
    <h2 class="h_4"><a href="index2.html" style="text-decoration: none; color: inherit;">School of Humanities and Social Sciences </a></h2>
 <!-- Navbar -->
 <nav class="navbar navbar-expand-lg navbar-light nav-castom_1">
    <div class="container-fluid">
      <img src="img/IITIndorelogo.png" href="index2.html" class="logo2">
